...
#define KERNBASE_UNCACHED   0x8000000000000000

#define KMEMSIZE            (128 << 20)                 // 128M the maximum amount of physical memory
 ...
 *              ------------> +---------------------------------+ 0x9FFFFFFFFFFFFFFF
 *                            |                                 | 
 *     KERNTOP  ------------> +       Unmapped cached(DMW0)     + 0x9000000007FFFFFF
 *                128M        |                                 | 
 *     KERNBASE-------------> +---------------------------------+ 0x9000000000000000
 *                            |                                 |
 *                            |    Unmapped uncached(DMW1)      | RW/-- KMEMSIZE
 *                            |                                 |
 *                            +---------------------------------+ 0x8000000000000000
 *                            |                                 |
 *                            |             Mapped              |
