...
#define LISA_CSR_RFPRMD		0x8f	// 64 TLB refill saving info
 ...
 * CSR_ExConfig IM
 */
#define ECFG0_IM		0x00071fff					//中断初始化修改0x00001fff-->0x00071fff
#define ECFGB_SIP0		0
...
#define __csrrd_d(/*ui14*/ _1) ((unsigned long long) __builtin_loongarch_csrrd_d ((_1)))
/* Assembly instruction format:	rd, ui14.  */
...
#define __csrwr_d(/*unsigned long long*/ _1, /*ui14*/ _2) \
  ((unsigned long long) __builtin_loongarch_csrwr_d ((unsigned long long) (_1), (_2)))
...
#define __csrxchg_d(/*unsigned long long*/ _1, /*unsigned long long*/ _2, /*ui14*/ _3) \
  ((unsigned long long) __builtin_loongarch_csrxchg_d ((unsigned long long) (_1), \
					       (unsigned long long) (_2), (_3)))
...
#define write_csr_entrylo0(val)		__csrwr_d(val, LISA_CSR_TLBELO0)
#define read_csr_entrylo1()		__csrrd(LISA_CSR_TLBELO1)
#define write_csr_entrylo1(val)		__csrwr_d(val, LISA_CSR_TLBELO1)
#define write_csr_stlbps(val)		__csrwr(val, 0x1e)
#define read_csr_stlbps()		__csrrd(0x1e)
#define write_csr_entryrhi(val)		__csrwr_d(val, LISA_CSR_RFENHI)
#define read_csr_entryrhi()		__csrrd_d(LISA_CSR_RFENHI)
#define write_csr_entryrlo0(val)		__csrwr_d(val, LISA_CSR_RFENLO0)
#define write_csr_entryrlo1(val)		__csrwr_d(val, LISA_CSR_RFENLO1)
#define read_csr_entryhi()		__csrrd(LISA_CSR_TLBEHI)
#define write_csr_entryhi(val)		__csrwr_d(val, LISA_CSR_TLBEHI)
